...
print(" \tSZ\tSZ3\tJP2SPWV\tSPERR")
print(f"Size\t{size_sz:.2f}MB\t{size_sz3:.2f}MB\t{size_jp2:.2f}MB\t{size_sperr:.2f}MB")
print(f"RMSE\t{rmse_sz:.3f}\t{rmse_sz3:.3f}\t{rmse_jp2:.3f}\t{rmse_sperr:.3f}")
print(f"MAX\t{max_sz:.3f}\t{max_sz3:.3f}\t{max_jp2:.3f}\t{max_sperr:.3f}")
